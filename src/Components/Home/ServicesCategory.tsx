  ...
  return (
    <div className="bg-[#fff8f5]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3  gap-5 px-5 md:px-10 pb-10">
        ...
        >
          <h3 className="uppercase font-semibold ">Premium</h3>
        </div>
        <div
        ...
        >
          <h3 className="uppercase font-semibold ">Make Over</h3>
        </div>
        <div
        ...
        >
          <h3 className="uppercase font-semibold ">Body Care</h3>
        </div>
        <div
        ...
        >
          <h3 className="uppercase font-semibold ">Hair Care</h3>
        </div>
        <div
        ...
        >
          <h3 className="uppercase font-semibold ">Bridal</h3>
        </div>
        <div
        ...
        >
          <h3 className="uppercase font-semibold ">Hair Cut</h3>
        </div>
        <div
        ...
        >
          <h3 className="uppercase font-semibold ">Hair Removal</h3>
        </div>
      </div>
    </div>
  );
