...
const SocialLogin = () => {
  ...
  return (
    <div>
     <div onClick={handleSigninWithGoogle} className="bg-white border mb-3 rounded-full p-2 text-center cursor-pointer hover:bg-slate-100 hover:shadow-md hover:border-blue-400">
